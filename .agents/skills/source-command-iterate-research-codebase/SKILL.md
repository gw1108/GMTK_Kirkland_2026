---
name: "source-command-iterate-research-codebase"
...
# source-command-iterate-research-codebase

Use this skill when the user asks to run the migrated source command `iterate-research-codebase`.
