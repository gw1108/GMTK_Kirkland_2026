---
name: "source-command-refine-research-question"
...
# source-command-refine-research-question

Use this skill when the user asks to run the migrated source command `refine-research-question`.
