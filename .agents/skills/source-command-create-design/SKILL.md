---
name: "source-command-create-design"
description: "Read a research document and work interactively with the user to settle on a design approach. Saves the agreed design to thoughts/shared/Codex-design/."
---

# source-command-create-design

Use this skill when the user asks to run the migrated source command `create_design`.
...
```
python "$(git rev-parse --show-toplevel)/thoughts/create_thought.py" Codex-design <file_name_description> [ticket]
```
